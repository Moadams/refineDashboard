...
export const authProvider: AuthBindings = {
  ...
  getIdentity: async () => {
    ...
    try {
      ...
      // we are using me:any because the GraphQL API doesn't have any type for the me query yet.
      // we will add some queries and mutations later and change this to User which will be generated by codegen.
